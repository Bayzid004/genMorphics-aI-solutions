      ...
      <div className="mt-12 bg-white mx-4 md:mx-auto md:max-w-5xl p-10 shadow rounded border-t-4 border-pink-500 flex flex-col md:flex-row items-center gap-10">
        ...
        <div className="flex-1">
          ...
          <p className="text-gray-600 leading-relaxed">
            Our creative writers possess a deep understanding of language
            nuances, enabling them to craft clear and consistent annotations,
            especially for tasks involving sentiment analysis, text
