    ...
    <footer className="bg-[#F3FAFF] pt-10 text-gray-700">
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 pb-10">
        ...
        <div>
          ...
          <p className="text-sm">
            Unleash the Potential of Your Data with Expert Labeling
            High-quality, Targeted Training Data for Superior Model Performance
          </p>
        </div>
        ...
        <div>
          ...
          <div className="flex gap-3 mt-4">
            <a href="#">
              <FaFacebookF className="w-8 h-8 p-2 bg-[#3b5998] text-white rounded" />
            </a>
            <a href="#">
              <FaTwitter className="w-8 h-8 p-2 bg-[#00acee] text-white rounded" />
            </a>
            <a href="#">
              <FaLinkedinIn className="w-8 h-8 p-2 bg-[#0A66C2] text-white rounded" />
            </a>
            <a href="#">
              <FaInstagram className="w-8 h-8 p-2 bg-black text-white rounded" />
            </a>
          </div>
        </div>
      </div>
